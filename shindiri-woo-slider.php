 ...
 * 
 * Requires at least: 2.3.0 WooCommerce plugin version, tested up to: 3.0.7
 * Shortcode integration works with at least: 4.4.0 Visual Composer version, tested up to: 5.1.1
 */
